...
- **packages/dilemmas/** — Consolidated from [godsons-ai/mse-dilemmas](https://github.com/godsons-ai/mse-dilemmas) (now archived). Contains 225+ parametric ethical dilemmas, import/export/validate scripts, and CC-BY-SA 4.0 license.
- **packages/react/** — Consolidated from [godsons-ai/mse-react](https://github.com/godsons-ai/mse-react) (now archived). Contains React visualization components (EthicalProfileCard, EthicalAxisBar, ExamsTab, etc.), data-fetching hooks, and TypeScript types.
